...
class Comments extends StatefulWidget {
  const Comments(
      {Key? key, required String this.postId, required bool this.isAdmin})
      : super(key: key);
...
class _CommentsState extends State<Comments> {
  ...
  static String? chooseName(String ownerId, Set<UserToPost> usersToPosts) {
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ListTile(
                              ...
                              title: Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Avatar(
                                        photo: chooseAvatar(
                                            item.ownerId!, state.usersToPosts),
                                        avatarSize: 15,
                                      ),
                              ...
                              trailing:
                                  isAdmin == true || user.id == item.ownerId
                                      ? IconButton(
                                          icon: const Icon(
                                            IconData(
                                              0xe1b9,
